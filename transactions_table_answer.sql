...
VALUES ('2021-01-16 00:05:54.000000', '25.05'),
...
select date(transaction_time)                                                              transaction_date,
       sum(transaction_amount)                                                             daily_amount,
       sum(sum(transaction_amount))
           over (order by date(transaction_time) rows between 2 preceding and current row) rolling_amount
from transactions
group by 1
order by 1